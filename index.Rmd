...
|             | *Break*                                         |             
| 12.30-15.00 | Your own project (continued)                    |
<!-- | *Thursday*  |                                                 | -->
...
- Part C: Packages and reading external data
    ...
    - [Extra RSQLite database to read from](Contents/Part C - External data/files/daltons.sqlite) (store on your own computer)
