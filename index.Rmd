...
type `Yes` in the console and press the return key. This might seem tricky forst time, but it will soon become second nature.
...
We adapt the course as we go. To ensure that you work with the latest iteration of the course materials, I advice all course participants to access the materials online at (https://peterstoltze.github.io/R_BiH_2023/).
